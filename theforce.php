<?php
	...
	/*
	 * This file must be used as is - DO NOT MODIFY THE CONTENTS OF OR SOURCE CODE IN THIS FILE.
	 *
	 * This file must be in the "A3" folder on your computer and test to see 
					...
					<ul class="navbar-nav mr-auto">
						<li class="nav-item">
							...
							if($_SESSION['logged_in']!=true){
								echo '<a class="nav-link" href="loginPage.php">Login</span></a>';
							}
